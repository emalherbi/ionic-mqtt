  ...
  return (function () {
  ...
  })()(
    {
        ...
        function (e, t, r) {
          (function (r, n) {
            ...
            function v(e, t) {
              ...
              for (r in ((this.options = t || {}),
              h("MqttClient :: options: %o", t),
              d))
              ...
              (this.options.clientId =
                ...
                this.on("connect", function () {
                  h("MqttClient:connect");
                  var e = this.queue;
                  !(function t() {
                    var r = e.shift();
                    h("MqttClient:deliver: entry %o", r);
                    var i;
                    r &&
                      ((i = r.packet),
                      h("MqttClient:deliver: call _sendPacket for %o", i),
                ...
                this.on("close", function () {
                  h("MqttClient: close event. Mark disconnected."),
                    (this.connected = !1),
                    clearTimeout(this.connackTimer),
                    h("MqttClient:close: clear ping timer"),
                    null !== n.pingTimer &&
                      (n.pingTimer.clear(), (n.pingTimer = null)),
                    h("MqttClient:close: call _setupReconnect"),
                    this._setupReconnect();
                }),
                i.call(this),
                h("MqttClient: call _setupStream"),
                this._setupStream();
            }
            u(v, i),
              (v.prototype._setupStream = function () {
                var e,
                  t = this,
                  n = new a(),
                ...
                function l() {
                  h("stream:work: called");
                  var e = u.shift();
                  if (e)
                    h("stream:work: calling _handlePacket"),
                      t._handlePacket(e, c);
                  else {
                    var r = o;
                    (o = null), h("stream:work: done is %s", !!r), r && r();
                  }
                }
                if (
                  (h("_setupStream: calling method to clear reconnect"),
                  this._clearReconnect(),
                  h("_setupStream: setting stream builder"),
                  (this.stream = this.streamBuilder(this)),
                  i.on("packet", function (e) {
                    h("parser: on packet push to packets array."), u.push(e);
                  }),
                  (n._write = function (e, t, r) {
                    (o = r),
                      h("stream:writable:_write: parsing buffer"),
                      i.parse(e),
                      l();
                  }),
                  h("_setupStream: piping stream to writable"),
                  this.stream.pipe(n),
                  ...
                  this.stream.on("close", function () {
                    ...
                    h("(%s)stream :: on close", t.options.clientId),
                      (e = t.outgoing) &&
                        (h("flushVolatile: queue exists? %s", !!e),
                  ...
                  if (
                    ...
                    y(
                      this,
                      f({ cmd: "auth", reasonCode: 0 }, this.options.authPacket)
                    );
                }
                this.stream.setMaxListeners(1e3),
                  clearTimeout(this.connackTimer),
                  (this.connackTimer = setTimeout(function () {
                    h("connectTimeout hit! Calling _cleanUp with force `true`"),
                      t._cleanUp(!0);
              ...
              (v.prototype.publish = function (e, t, r, n) {
                var i;
                h("MqttClient:publish `%s` to topic `%s`", t, e);
                var o = this.options;
                ...
                switch (
                  ...
                  case 1:
                  case 2:
                    (this.outgoing[i.messageId] = { volatile: !1, cb: n || _ }),
              ...
              (v.prototype.subscribe = function () {
                ...
                if (
                  ...
                  "string" == typeof o && (o = [o]),
                  "function" != typeof a && ((u = a), (a = _)),
                  null !== (n = l.validateTopics(o)))
                )
                  return p(a, new Error("Invalid topic " + n)), this;
                if (this._checkDisconnecting(a))
                  return h("subscribe: discconecting true"), this;
                var g = { qos: 0 };
                if (
                  (5 === d && ((g.nl = !1), (g.rap = !1), (g.rh = 0)),
                  (u = f(g, u)),
                  Array.isArray(o)
                    ? o.forEach(function (e) {
                        if (
                          (h("subscribe: array topic %s", e),
                          !c._resubscribeTopics.hasOwnProperty(e) ||
                            c._resubscribeTopics[e].qos < u.qos ||
                            s)
                        ) {
                    ...
                    : Object.keys(o).forEach(function (e) {
                        if (
                          ...
                          !c._resubscribeTopics.hasOwnProperty(e) ||
                            c._resubscribeTopics[e].qos < o[e].qos ||
                            s)
                        ) {
                  ...
                  u.properties && (e.properties = u.properties),
                  i.length)
                ) {
                    ...
                    i.forEach(function (e) {
                      if (c.options.reconnectPeriod > 0) {
                        ...
                        5 === d &&
                          ...
                          (c._resubscribeTopics[e.topic] = t),
                          b.push(e.topic);
                      }
                    }),
                  ...
                  return (
                    ...
                    h("subscribe: calling _sendPacket"),
                    this._sendPacket(e),
                    this
                  );
                }
                ...
                return (
                  ...
                  this._checkDisconnecting(o)
                    ...
                    : ("string" == typeof i
                      ...
                      (this.outgoing[e.messageId] = { volatile: !0, cb: o }),
                      h("unsubscribe: send packet"),
                      this._sendPacket(e),
                      this)
                );
              }),
              (v.prototype.end = function (e, t, n) {
                      ...
                      () => {
                        h(
                          ...
                          r.nextTick(
                            function () {
                              h(
                                "end :: (%s) :: closeStores: closing incoming and outgoing stores",
                                i.options.clientId
                              ),
                                (i.disconnected = !0),
                                i.incomingStore.close(function () {
                                  i.outgoingStore.close(function () {
                                    h(
                                      "end :: (%s) :: closeStores: emitting end",
                                      i.options.clientId
                                    ),
                                      i.emit("end"),
                                      n &&
                                        (h(
                                          "end :: (%s) :: closeStores: invoking callback with args",
                                          i.options.clientId
                                        ),
                                        n());
                                  });
                ...
                return (
                  (null != e && "boolean" == typeof e) ||
                    ...
                    (e = !1),
                    "object" != typeof t &&
                      ((n = t), (t = null), "function" != typeof n && (n = _))),
                ...
                var t = this,
                  r = function () {
                    e
                      ...
                      (t.incomingStore = t.options.incomingStore || new o()),
                      (t.outgoingStore = t.options.outgoingStore || new o()),
                      (t.disconnecting = !1),
                      (t.disconnected = !1),
              ...
              (v.prototype._setupReconnect = function () {
                ...
                e.options.reconnectPeriod > 0
                  ? (this.reconnecting ||
                      (h("_setupReconnect :: emitting offline state"),
                      this.emit("offline"),
                      (this.reconnecting = !0)),
                    h(
                    ...
                    (e.reconnectTimer = setInterval(function () {
                      h("reconnectTimer calling _reconnect()"), e._reconnect();
                    }, e.options.reconnectPeriod)))
                  : h("_setupReconnect :: doing nothing...");
              }),
              (v.prototype._clearReconnect = function () {
                h("_clearReconnect called. clearing reconnectTimer"),
                  this.reconnectTimer &&
              ...
              (v.prototype._cleanUp = function (e, t) {
                ...
                if (
                  (t &&
                    (h("_cleanUp: done callback provided for on stream close"),
                  ...
                  0 === this.options.reconnectPeriod &&
                    this.options.clean &&
                    (r = this.outgoing) &&
                    (h("flush: queue exists? %b", !!r),
                    Object.keys(r).forEach(function (e) {
                      "function" == typeof r[e].cb &&
                        (r[e].cb(new Error("Connection closed")), delete r[e]);
                    })),
                    h("(%s)_cleanUp: destroying stream", this.options.clientId),
                    this.stream.destroy();
                else {
                  var i = f({ cmd: "disconnect" }, n);
                  h(
                    "(%s)_cleanUp: sending disconnect packet",
                    this.options.clientId
                  ),
                    this._sendPacket(
                      i,
                      p.bind(null, this.stream.end.bind(this.stream))
                    );
                }
                this.disconnecting ||
                  (h(
                  ...
                  t &&
                    !this.connected &&
                    (h(
                      "(%s)_cleanUp: removing stream `done` callback `close` listener",
                      this.options.clientId
                    ),
              ...
              (v.prototype._sendPacket = function (e, t, r) {
                if (
                  (h("_sendPacket :: (%s) ::  start", this.options.clientId),
                  (r = r || _),
                  !this.connected)
                )
                  return (
              ...
              (v.prototype._checkPing = function () {
                h("_checkPing :: checking ping..."),
                  this.pingResp
                    ...
                    : (h("_checkPing :: calling _cleanUp with force true"),
                      this._cleanUp(!0));
              }),
              ...
              (v.prototype._handlePublish = function (e, t) {
                h("_handlePublish: packet %o", e), (t = void 0 !== t ? t : _);
                        ...
                        i
                          ...
                          : (a || s.emit("message", r, n, e),
                            void s.handleMessage(e, function (e) {
                              if (e) return t && t(e);
                              s._sendPacket(
                                { cmd: "puback", messageId: o, reasonCode: a },
                                t
                              );
                            }))
                      );
              ...
              (v.prototype._handleAck = function (e) {
                ...
                var t,
                  ...
                  s = this;
                if (o) {
                  switch ((h("ack packet of type: %s", n), n)) {
                    case "pubcomp":
                    case "puback":
                      var a = e.reasonCode;
                      a &&
                        a > 0 &&
                        16 !== a &&
                        (((t = new Error("Publish error: " + b[a])).code = a),
                        o(t, e)),
                    ...
                    case "pubrec":
                      ...
                      var u = e.reasonCode;
                      u && u > 0 && 16 !== u
                        ? (((t = new Error("Publish error: " + b[u])).code = u),
                          o(t, e))
                        : this._sendPacket(i);
                      break;
                    case "suback":
                ...
                } else h("Server sent an ack in error. Ignoring.");
              }),
              (v.prototype._handlePubrel = function (e, t) {
                h("handling pubrel packet"), (t = void 0 !== t ? t : _);
                var r = this,
                  n = { cmd: "pubcomp", messageId: e.messageId };
                r.incomingStore.get(e, function (e, i) {
                  e
                    ? r._sendPacket(n, t)
                    : (r.emit("message", i.topic, i.payload, i),
                      r.handleMessage(i, function (e) {
                        if (e) return t(e);
                        r.incomingStore.del(i, _), r._sendPacket(n, t);
                      }));
                });
              }),
                    ...
                    if (5 === this.options.protocolVersion) {
                      ...
                      for (var r = 0; r < t.length; r++) {
                        ...
                        (n[t[r]] = this._resubscribeTopics[t[r]]),
                          (n.resubscribe = !0),
                          this.subscribe(n, { properties: n[t[r]].properties });
                      }
                    } else
      ...
      2: [
        ...
        { "base64-js": 10, buffer: 12, duplexify: 18, "readable-stream": 116 },
      ],
      3: [
        function (e, t, r) {
          "use strict";
      ...
      5: [
        function (e, t, r) {
          (function (r) {
            "use strict";
            var n = e("debug")("mqttjs:connect:ws"),
            ...
            function u(e, t) {
              ...
              !(function (e) {
                e.hostname || (e.hostname = "localhost"),
                  e.port ||
                    ("wss" === e.protocol ? (e.port = 443) : (e.port = 80)),
                  e.path || (e.path = "/"),
                  e.wsOptions || (e.wsOptions = {}),
                  a ||
                    "wss" !== e.protocol ||
              ...
              return (
                n("creating new Websocket for url: %s and protocol: %s", o, r),
                i(o, [r], t.wsOptions)
              );
            }
            t.exports = a
        ...
        { _process: 100, debug: 16, url: 132, "websocket-stream": 137 },
      ],
      6: [
        function (e, t, r) {
          (function (r, n) {
            ...
            t.exports = function (e, t) {
              ...
              (i = wx.connectSocket({ url: l, protocols: c })),
                (o = (function () {
                  var e = new a();
                  return (
                    (e._write = function (e, t, r) {
              ...
              return (
                ...
                i.onMessage(function (e) {
                  var t = e.data;
                  (t =
                    t instanceof ArrayBuffer ? n.from(t) : n.from(t, "utf8")),
                    o.push(t);
                }),
                i.onClose(function () {
                  s.end(), s.destroy();
        ...
        { _process: 100, buffer: 12, duplexify: 18, "readable-stream": 116 },
      ],
      7: [
        function (e, t, r) {
          (function (r) {
        ...
        { _process: 100, "es6-map": 67, "readable-stream": 116, xtend: 140 },
      ],
      8: [
        function (e, t, r) {
          "use strict";
      ...
      12: [
          ...
          (function (t) {
            ...
            function a(e, r, n) {
              ...
              var o = (function (e) {
                ...
                if (void 0 !== e.length)
                  return "number" != typeof e.length || F(e.length)
                    ? s(0)
                    : l(e);
            ...
            (r.kMaxLength = o),
              ...
              (t.compare = function (e, r) {
                if (
                  (q(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)),
                  q(r, Uint8Array) && (r = t.from(r, r.offset, r.byteLength)),
            ...
            function U(e) {
              return n.toByteArray(
                (function (e) {
                  if (
                    (e = (e = e.split("=")[0]).trim().replace(B, "")).length < 2
                  )
                    return "";
                  for (; e.length % 4 != 0; ) e += "=";
                  return e;
        ...
        { "base64-js": 10, buffer: 12, ieee754: 86 },
      ],
      13: [
        function (e, t, r) {
          (function (e) {
          ...
          (t.exports = function (e, t) {
            ...
            return (
              ...
              n(e)
                ? ((r = a.call(e, "c")),
                  ...
                  (u = a.call(e, "w")))
                : ((r = u = !0), (i = !1)),
              (l = { value: t, configurable: r, enumerable: i, writable: u }),
              c ? o(s(c), l) : l
            );
          }).gs = function (e, t, r) {
            var u, c, l, f;
            return (
              ...
              n(t)
                ...
                : (t = void 0),
              n(e)
                ? ((u = a.call(e, "c")), (c = a.call(e, "e")))
                : ((u = !0), (c = !1)),
              (f = { get: t, set: r, configurable: u, enumerable: c }),
              l ? o(s(l), f) : f
            );
          };
        },
        {
          "es5-ext/object/assign": 37,
          "es5-ext/object/normalize-options": 49,
            ...
            function n() {
              if (n.enabled) {
                var e = n,
                  i = +new Date(),
                  o = i - (t || i);
                (e.diff = o), (e.prev = t), (e.curr = i), (t = i);
                for (
                ...
                (s[0] = s[0].replace(/%([a-zA-Z%])/g, function (t, n) {
                  ...
                  (n.log || r.log || console.log.bind(console)).apply(e, s);
              }
            }
            return (
              (n.namespace = e),
        ...
        function (e, t, r) {
          (function (r, n) {
            var i = e("readable-stream"),
              ...
              a = e("stream-shift"),
              u =
                n.from && n.from !== Uint8Array.from ? n.from([0]) : new n([0]),
              c = function (e, t) {
            ...
            s(f, i.Duplex),
              ...
              (f.prototype._write = function (e, t, r) {
                return this.destroyed
                  ? r()
                  : this._corked
                  ? c(this, this._write.bind(this, e, t, r))
                  : e === u
                  ? this._finish(r)
                  : this._writable
              ...
              (f.prototype.end = function (e, t, r) {
                return "function" == typeof e
                  ...
                  : ((this._ended = !0),
                    e && this.write(e),
                    this._writableState.ending || this.write(u),
        ...
        function (e, t, r) {
          ...
          t.exports = function (e) {
            ...
            for (
              r = i(o(this).length),
                l = arguments[1],
                t = l = isNaN(l) ? 0 : l >= 0 ? c(l) : i(this.length) - c(u(l));
              t < r;
              ++t
            )
      ...
      24: [
        function (e, t, r) {
          ...
          t.exports = function (e) {
            ...
            if (!f(e))
              if (void 0 !== (w = e[n])) {
                for (
                  _ = a(w).call(e), t && (b = new t()), v = _.next(), r = 0;
                  !v.done;

                )
                  (S = x ? h.call(x, k, v.value, r) : v.value),
                ...
                for (y = e.length, t && (b = new t()), r = 0, g = 0; r < y; ++r)
                  (S = e[r]),
                    r + 1 < y &&
                      (m = S.charCodeAt(0)) >= 55296 &&
                      m <= 56319 &&
                      (S += e[++r]),
                    (S = x ? h.call(x, k, S, g) : S),
                    t ? ((p.value = S), d(b, g, p)) : (b[g] = S),
                    ++g;
                y = g;
              }
            if (void 0 === y)
        ...
        {
          "../../function/is-arguments": 25,
          "../../function/is-function": 26,
          "../../number/to-pos-integer": 35,
          "../../object/is-value": 44,
      ...
      36: [
        ...
        { "./valid-callable": 54, "./valid-value": 55 },
      ],
      37: [
        function (e, t, r) {
          "use strict";
        ...
        function (e, t, r) {
          ...
          t.exports = function (e, t) {
            ...
            for (
              ...
              (t = arguments[s]), n(t).forEach(a);
            if (void 0 !== r) throw r;
            return e;
          };
        },
        { "../keys": 45, "../valid-value": 55 },
      ],
      40: [
        function (e, t, r) {
          "use strict";
        ...
        { "../array/from": 22, "./assign": 37, "./valid-value": 55 },
      ],
      41: [
        function (e, t, r) {
          "use strict";
      ...
      53: [
            ...
            (t.exports = (i = (function () {
              ...
              ? (2 === i.level
                  ...
                  : (o = function e(t, r) {
                      ...
                      return (
                        n(t, r),
                        (i = c.call(e.nullPolyfill, t)) &&
                          delete e.nullPolyfill.__proto__,
                        null === r && (r = e.nullPolyfill),
                        (t.__proto__ = r),
                        i && l(e.nullPolyfill, "__proto__", f),
                        t
                      );
                    }),
        ...
        { "../create": 41, "../is-object": 43, "../valid-value": 55 },
      ],
      54: [
        function (e, t, r) {
          "use strict";
      ...
      61: [
        ...
        {
          "./get": 62,
          "es5-ext/function/is-arguments": 25,
        ...
        function (e, t, r) {
          ...
          (t.exports = n = function () {
            ...
            if (!(this instanceof n))
              throw new TypeError("Constructor requires 'new'");
            return (
              (r = g && s && Map !== n ? s(new Map(), m(this)) : this),
              null != i && h(i),
              y(r, {
      ...
      73: [
        ...
        { "./is-implemented": 74, "./polyfill": 79, "ext/global-this": 84 },
      ],
      74: [
        function (e, t, r) {
          "use strict";
          ...
          (i = function (e) {
            ...
            (t.exports = n = function e(t) {
              ...
              return o
                ...
                : ((r = h(i.prototype)),
                  (t = void 0 === t ? "" : String(t)),
                  p(r, { __description__: s("", t), __name__: s("", c(t)) }));
            }),
            l(n),
            f(n),
            p(i.prototype, {
            ...
            d(i.prototype, n.toStringTag, s("c", n.prototype[n.toStringTag])),
            d(i.prototype, n.toPrimitive, s("c", n.prototype[n.toPrimitive]));
        },
        {
          "./lib/private/generate-name": 76,
          "./lib/private/setup/standard-symbols": 77,
          "./lib/private/setup/symbol-registry": 78,
          "./validate-symbol": 80,
          d: 15,
          "ext/global-this": 84,
        },
      ...
      81: [
        function (e, t, r) {
          ...
          (a = {
            ...
            (u = { on: l(n), once: l(i), off: l(o), emit: l(s) }),
            (c = b({}, u)),
        ...
        { d: 15, "es5-ext/object/valid-callable": 54 },
      ],
      82: [
        function (e, t, r) {
          var n =
      ...
      84: [
        ...
        { "./implementation": 83, "./is-implemented": 85 },
      ],
      85: [
        function (e, t, r) {
          "use strict";
      ...
      89: [
        function (e, t, r) {
          ...
          (i.propertiesTypes = {
            ...
            (i.PUBLISH_HEADER = c("publish")),
            (i.SUBSCRIBE_HEADER = c("subscribe")),
            ...
            (i.UNSUBSCRIBE_HEADER = c("unsubscribe")),
            (i.ACKS = {
              unsuback: c("unsuback"),
              puback: c("puback"),
              pubcomp: c("pubcomp"),
      ...
      90: [
        ...
        { "./writeToStream": 96, events: 82, inherits: 87, "safe-buffer": 118 },
      ],
      91: [
        function (e, t, r) {
          "use strict";
        ...
        { "./generate": 90, "./parser": 95, "./writeToStream": 96 },
      ],
      92: [
        function (e, t, r) {
          ...
          function s(e) {
            ...
            if (
              ((this._bufs = []), (this.length = 0), "function" == typeof e)
            ) {
              this._callback = e;
              var t = function (e) {
          ...
          i.inherits(s, n),
            ...
            (s.prototype.copy = function (e, t, r, n) {
              ...
              if (l <= this._bufs[u[0]].length - h)
                return a
                  ? this._bufs[u[0]].copy(e, t, h, h + l)
                  : this._bufs[u[0]].slice(h, h + l);
              for (
                a || (e = o.allocUnsafe(c)), s = u[0];
                s < this._bufs.length;
                s++
              ) {
        ...
        { "readable-stream/duplex": 105, "safe-buffer": 118, util: 136 },
      ],
      93: [
        function (e, t, r) {
          "use strict";
      ...
      95: [
        function (e, t, r) {
          ...
          i(u, o),
            ...
            (u.prototype.parse = function (e) {
              for (
                this.error && this._resetState(), this._list.append(e);
            ...
            (u.prototype._parseLength = function () {
              ...
              return (
                e &&
                  ((this.packet.length = e.value), this._list.consume(e.bytes)),
                !!e
              );
            }),
            ...
            (u.prototype._parseConnect = function () {
              ...
              if (
                ...
                (s.will = this._list.readUInt8(this._pos) & a.WILL_FLAG_MASK),
                s.will &&
                  ((u.will = {}),
                  (u.will.retain =
                    0 !=
                    (this._list.readUInt8(this._pos) & a.WILL_RETAIN_MASK)),
                  (u.will.qos =
                    (this._list.readUInt8(this._pos) & a.WILL_QOS_MASK) >>
                    a.WILL_QOS_SHIFT)),
                (u.clean =
                  0 !=
                  (this._list.readUInt8(this._pos) & a.CLEAN_SESSION_MASK)),
                this._pos++,
            ...
            (u.prototype._parseConnack = function () {
              ...
              if (
                ((e.sessionPresent = !!(
                  this._list.readUInt8(this._pos++) & a.SESSIONPRESENT_MASK
                )),
            ...
            (u.prototype._parseSubscribe = function () {
              ...
              if (((u.subscriptions = []), this._parseMessageId())) {
                ...
                for (; this._pos < u.length; ) {
                  if (null === (e = this._parseString()))
                    return this._emitError(new Error("Cannot parse topic"));
                  (r = (t = this._parseByte()) & a.SUBSCRIBE_OPTIONS_QOS_MASK),
                    (o =
                      0 !=
            ...
            (u.prototype._parseConfirmation = function () {
              ...
              if (
                ...
                5 === this.settings.protocolVersion && e.length > 2)
              ) {
            ...
            (u.prototype._parseAuth = function () {
              ...
              var t = this._parseProperties();
              return (
                Object.getOwnPropertyNames(t).length && (e.properties = t), !0
              );
            }),
            ...
            (u.prototype._parseString = function (e) {
              var t,
                r = this._parseNum(),
                n = r + this._pos;
              return -1 === r || n > this._list.length || n > this.packet.length
                ? null
            ...
            (u.prototype._parseBuffer = function () {
              var e,
                t = this._parseNum(),
                r = t + this._pos;
              return -1 === t || r > this._list.length || r > this.packet.length
                ? null
                : ((e = this._list.slice(this._pos, r)), (this._pos += t), e);
            }),
            ...
            (u.prototype._parseVarByteNum = function (e) {
              for (
                ...
                r < 5 &&
                ((i +=
                  n * ((t = this._list.readUInt8(s + r++)) & a.LENGTH_MASK)),
                (n *= 128),
            ...
            (u.prototype._parseProperties = function () {
              for (
                var e = this._parseVarByteNum(), t = this._pos + e, r = {};
                this._pos < t;
        ...
        { "./constants": 89, "./packet": 94, bl: 92, events: 82, inherits: 87 },
      ],
      96: [
        function (e, t, r) {
          "use strict";
          var n = e("./constants"),
            ...
            p = a.generate4ByteBuffer,
            d = S,
            g = !0;
          function b(e, t, r) {
            switch (
              (t.cork && (t.cork(), u(y, t)), g && ((g = !1), f()), e.cmd)
            ) {
              case "connect":
                return (function (e, t, r) {
                  var o = e || {},
                  ...
                  if (3 !== a && 4 !== a && 5 !== a)
                    return (
                      t.emit("error", new Error("Invalid protocol version")), !1
                    );
                  b += 1;
                  if (
                  ...
                  if ("number" != typeof l || l < 0 || l > 65535 || l % 1 != 0)
                  ...
                  if (u) {
                    ...
                    if (!u.topic || "string" != typeof u.topic)
                      return (
                        t.emit("error", new Error("Invalid will topic")), !1
                      );
                    if (((b += i.byteLength(u.topic) + 2), u.payload)) {
                      if (!(u.payload.length >= 0))
                        return (
                          t.emit("error", new Error("Invalid will payload")), !1
                        );
                      "string" == typeof u.payload
                        ? (b += i.byteLength(u.payload) + 2)
                        : (b += u.payload.length + 2);
                      var m = {};
                  ...
                  t.write(n.CONNECT_HEADER),
                    ...
                    E(t, s),
                    t.write(
                      4 === a ? n.VERSION4 : 5 === a ? n.VERSION5 : n.VERSION3
                    );
                  var S = 0;
                  (S |= null != h ? n.USERNAME_MASK : 0),
                    (S |= null != p ? n.PASSWORD_MASK : 0),
                    (S |= u && u.retain ? n.WILL_RETAIN_MASK : 0),
                    (S |= u && u.qos ? u.qos << n.WILL_QOS_SHIFT : 0),
                    (S |= u ? n.WILL_FLAG_MASK : 0),
                    (S |= c ? n.CLEAN_SESSION_MASK : 0),
                    t.write(i.from([S])),
                    d(t, l),
                    5 === a && y.write();
                  E(t, f),
                    u && (5 === a && m.write(), v(t, u.topic), E(t, u.payload));
                  null != h && E(t, h);
                  null != p && E(t, p);
                  return !0;
                })(e, t);
              case "connack":
                return (function (e, t, r) {
                  ...
                  if ("number" != typeof u)
                    return (
                      t.emit("error", new Error("Invalid return code")), !1
                    );
                  var f = null;
                  5 === o && ((f = I(t, c)), (l += f.length));
                  t.write(n.CONNACK_HEADER),
                    _(t, l),
                    t.write(a.sessionPresent ? n.SESSIONPRESENT_HEADER : s),
                    t.write(i.from([u])),
                    null != f && f.write();
                  return !0;
                })(e, t, r);
              case "publish":
                return (function (e, t, r) {
                  ...
                  if (u && "number" != typeof h)
                    return t.emit("error", new Error("Invalid messageId")), !1;
                  u && (g += 2);
                  var b = null;
                  5 === s && ((b = I(t, p)), (g += b.length));
                  t.write(n.PUBLISH_HEADER[u][a.dup ? 1 : 0][c ? 1 : 0]),
                    _(t, g),
                    d(t, j(l)),
                    t.write(l),
                    u > 0 && d(t, h);
              ...
              case "pubcomp":
                return (function (e, t, r) {
                  ...
                  var g = null;
                  if (5 === o) {
                    if (!(g = C(t, h, r, p))) return !1;
                    p += g.length;
                  }
                  t.write(n.ACKS[a][l][c][0]),
                    _(t, p),
                    d(t, u),
              ...
              case "subscribe":
                return (function (e, t, r) {
                  ...
                  if ("object" != typeof c || !c.length)
                    return (
                      t.emit("error", new Error("Invalid subscriptions")), !1
                    );
                  ...
                  for (var S = !0, x = 0; x < c.length; x++) {
                    var k,
                      ...
                      A = E.rh;
                    v(t, C),
                      (k = n.SUBSCRIBE_OPTIONS_QOS[O]),
                      5 === o &&
                        ((k |= j ? n.SUBSCRIBE_OPTIONS_NL : 0),
                        (k |= T ? n.SUBSCRIBE_OPTIONS_RAP : 0),
                        (k |= A ? n.SUBSCRIBE_OPTIONS_RH[A] : 0)),
                      (S = t.write(i.from([k])));
                  }
                  return S;
                })(e, t, r);
              ...
              case "unsubscribe":
                return (function (e, t, r) {
                  ...
                  if ("object" != typeof c || !c.length)
                    return (
                      t.emit("error", new Error("Invalid unsubscriptions")), !1
                    );
                  for (var h = 0; h < c.length; h += 1) {
                    if ("string" != typeof c[h])
                      return (
                        t.emit("error", new Error("Invalid unsubscriptions")),
                        !1
                      );
              ...
              case "unsuback":
                return (function (e, t, r) {
                  ...
                  var g = null;
                  if (5 === o) {
                    if (!(g = C(t, l, r, h))) return !1;
                    h += g.length;
                  }
                  t.write(n.ACKS[f][0][u][0]),
                    _(t, h),
                    d(t, a),
                    null !== g && g.write();
          ...
          Object.defineProperty(b, "cacheNumbers", {
            ...
            set: function (e) {
              e
                ? ((c && 0 !== Object.keys(c).length) || (g = !0), (d = S))
                : ((g = !1), (d = x));
            },
          });
          var m = {};
          function _(e, t) {
            var r = m[t];
            r || ((r = h(t).data), t < 16384 && (m[t] = r)), e.write(r);
          }
          function v(e, t) {
                ...
                case "pair":
                  ...
                  a += Object.getOwnPropertyNames(s).reduce(function (e, t) {
                    return (e +=
                      ...
                      2 +
                      i.byteLength(s[t].toString()));
                  }, 0);
                  break;
                default:
                  return (
                    e.emit("error", new Error("Invalid property " + r)), !1
                  );
              }
              return a;
            }
                ...
                switch (n.propertiesTypes[o]) {
                  ...
                  case "pair":
                    Object.getOwnPropertyNames(s).forEach(function (t) {
                      e.write(i.from([n.properties[o]])),
                        w(e, t.toString(), s[t].toString());
                    });
                    break;
                  default:
                    return (
                      e.emit("error", new Error("Invalid property " + o)), !1
                    );
                }
              }
          }
            ...
            !(function (n) {
              ...
              function C(e, t) {
                ...
                return (
                  ...
                  n + I((e = e.replace(v, ".")).split("."), t).join(".")
                );
              }
              function O(e) {
                  ...
                  for (
                    ...
                    i >= v && E("invalid-input"),
                      ((u =
                        ...
                        E("overflow"),
                      (w += u * s),
                      !(u < (p = a <= k ? f : a >= k + h ? h : a - k));
                    a += l
                  )
                    s > x(c / (d = l - p)) && E("overflow"), (s *= d);
                  (k = A(w - o, (t = _.length + 1), 0 == o)),
                    x(w / t) > c - S && E("overflow"),
                    (S += x(w / t)),
                    (w %= t),
                    _.splice(w++, 0, S);
                }
              ...
              function M(e) {
                var t,
                  ...
                  I = [];
                for (
                  _ = (e = O(e)).length, t = b, r = 0, o = g, s = 0;
                  s < _;
                  ++s
                )
                  (m = e[s]) < 128 && I.push(k(m));
                for (n = i = I.length, i && I.push(y); n < _; ) {
                  for (a = c, s = 0; s < _; ++s)
                    (m = e[s]) >= t && m < a && (a = m);
                  for (
                    a - t > x((c - r) / (v = n + 1)) && E("overflow"),
                      r += (a - t) * v,
                      t = a,
                      s = 0;
                    s < _;
      ...
      107: [
        ...
        { "./_stream_transform": 109, "core-util-is": 13, inherits: 87 },
      ],
      108: [
        function (e, t, r) {
          (function (r, n) {
            ...
            (_.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? P(this) : k(this),
                  null
                );
              ...
              (_.prototype.on = function (e, t) {
                ...
                if ("data" === e)
                  ...
                  n.endEmitted ||
                    ...
                    (n.emittedReadable = !1),
                    n.reading ? n.length && k(this) : i.nextTick(O, this));
                }
                return r;
              }),
      ...
      109: [
        ...
        { "./_stream_duplex": 106, "core-util-is": 13, inherits: 87 },
      ],
      110: [
        function (e, t, r) {
          (function (r, n, i) {
      ...
      120: [
        ...
        { "process/browser.js": 100, timers: 120 },
      ],
      121: [
        function (e, t, r) {
          "use strict";
      ...
      132: [
          ...
          (o.prototype.parse = function (e, t, r) {
            ...
            if (!b[w] && (x || (w && !y[w]))) {
              for (var k, E, I = -1, C = 0; C < h.length; C++) {
                -1 !== (O = _.indexOf(h[C])) && (-1 === I || O < I) && (I = O);
              }
              -1 !==
                (E = -1 === I ? _.lastIndexOf("@") : _.lastIndexOf("@", I)) &&
                ((k = _.slice(0, E)),
                (_ = _.slice(E + 1)),
              ...
              if (!j)
                for (
                  var T = this.hostname.split(/\./), A = ((C = 0), T.length);
                  C < A;
                  C++
                ) {
                  var P = T[C];
            ...
            var W = _.indexOf("#");
            -1 !== W && ((this.hash = _.substr(W)), (_ = _.slice(0, W)));
            var K = _.indexOf("?");
            if (
              (-1 !== K
                ? ((this.search = _.substr(K)),
                  (this.query = _.substr(K + 1)),
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              k &&
                ((r.hostname = r.host = T ? "" : x.length ? x.shift() : ""),
                (j =
                  !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) &&
                  ((r.auth = j.shift()), (r.host = r.hostname = j.shift())));
              return (
                (w = w || (r.host && x.length)) && !T && x.unshift(""),
                x.length
                  ? (r.pathname = x.join("/"))
        ...
        { "./util": 133, punycode: 101, querystring: 104 },
      ],
      133: [
        function (e, t, r) {
          "use strict";
      ...
      136: [
        ...
        { "./support/isBuffer": 135, _process: 100, inherits: 87 },
      ],
      137: [
        function (e, t, r) {
          (function (r, n) {
            ...
            t.exports = function (e, t, u) {
                ...
                p = f
                  ? function e(t, r, n) {
                      if (l.bufferedAmount > g)
                        return void setTimeout(e, b, t, r, n);
              ...
              u || (u = {});
              void 0 === u.objectMode &&
                (u.objectMode = !(!0 === u.binary || void 0 === u.binary));
              ...
              "object" == typeof e
                ? (l = e)
                : ((l = h && f ? new s(e, t) : new s(e, t, u)).binaryType =
                    "arraybuffer");
              l.readyState === l.OPEN
                ? (c = d)
                : ((c = o.obj()),
